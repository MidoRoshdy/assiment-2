void main() {
  List<Map<String, dynamic>> retailerDetails = [
    {
      "id": "0ZR",
      ...
      "data": null,
      "contact": {
        "emails": ["info@mystore.Com"],
        "phones": ["0110304002", "05000001000"],
  ...
  retailerDetails.forEach((element) {
    print(
        " --- name :${element["name"]} catogery ${element["categories"]} address${element["geo_point"]} ");
  });
}
